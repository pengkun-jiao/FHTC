...
The standalone [Dual-LoRA Python package](https://github.com/pengkun-jiao/dual-lora-python) provides simple PyTorch adapter injection, training helpers, and safetensors checkpoint saving/loading.

```bash
python -m pip install git+https://github.com/pengkun-jiao/dual-lora-python.git
```

See the [quick start](https://github.com/pengkun-jiao/dual-lora-python#quick-start), [中文使用说明](https://github.com/pengkun-jiao/dual-lora-python/blob/main/README.zh-CN.md), and [validation notes](https://github.com/pengkun-jiao/dual-lora-python/blob/main/VALIDATION.md). The package covers Dual-LoRA adapters; the VCE module and full visual instruction-tuning pipeline remain in this research repository.
